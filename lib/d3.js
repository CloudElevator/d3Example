d3 = function() {
  ...
  //var d3_time = Date, d3_time_daySymbols = [ "星期日","星期一", "星期二", "星期三", "星期四", "星期五", "星期六" ];
  ...
  var d3_time_days = [ "周日", "周一", "周二", "周三", "周四", "周五", "周六" ], d3_time_dayAbbreviations = [ "周日", "周一", "周二", "周三", "周四", "周五", "周六" ], d3_time_months = [ "一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月" ], d3_time_monthAbbreviations = [ "1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月" ];
   ...
   * [ d3.time.format("%b %d"), function(d) {
    return d.getDate() != 1;将这种时间显示格式改为%b%d
  } ]
   [ d3.time.format("%a %d"), function(d) {
    return d.getDay() && d.getDate() != 1;
  } ]将这种时间显示格式改为 %d日%a
   *  [ d3.time.format("%I %p"), function(d) {
    return d.getHours();将这种时间显示格式改为%H:%M
  } ]
   * */
  var d3_time_scaleLocalFormats = [ [ d3.time.format("%Y"), d3_true ], [ d3.time.format("%B"), function(d) {
    ...
    return d.getDate() != 1;
  } ], [ d3.time.format("%d日%a"), function(d) {
    return d.getDay() && d.getDate() != 1;
  ...
  } ], [ d3.time.format.utc("%d日%a"), function(d) {
    return d.getUTCDay() && d.getUTCDate() != 1;
  } ], [ d3.time.format.utc("%H:%M"), function(d) {
    return d.getUTCHours();
